...
// callmethod做：rpc请求的数据组装、数据的序列化；发送rpc请求并且wait；接收rpc响应；响应的反序列化
                          ...
                          google::protobuf::Closure* done)
{
    ...
    // rpc调用方想调用service_name和mtehod_name服务，需要查询zk上该服务所在的host信息
    ZkClient zkCli;
    zkCli.Start();

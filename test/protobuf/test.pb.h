...
class UserServiceRpc_Stub : public UserServiceRpc {
 public:
  UserServiceRpc_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel);  // 带参构造函数
  ...
  // login和getfriendlists也是虚函数 因为UserServiceRpc_Stub是继承自UserServiceRpc的 基类中的这两个函数就是虚函数 重写完也是虚函数
